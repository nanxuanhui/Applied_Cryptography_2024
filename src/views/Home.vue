                  ...
                  <v-row>
                    <v-col cols="12" md="6">
                      <v-card-text class="mt-12">
                        ...
                        >Once logged in, you can download the contents of the school's files and view them</h6>
                        <v-row align="center" justify="center">
                          <v-col cols="12" sm="8">
                    ...
                    <div style="  text-align: center; padding: 180px 0;">
                      <v-card-text class="white--text" >
                        ...
                        <h6
                          class="text-center"
                        >Log in to view the school's file contents</h6>
                      </v-card-text>
                  ...
                  <v-row >
                    <v-col cols="12" md="6" class="blue rounded-br-xl">
                     <div style="  text-align: center; padding: 180px 0;">
                      <v-card-text class="white--text" >
                        ...
                        <h6
                          class="text-center"
                        >Already have an account? Once logged in, you can download the contents of the school's files and view them</h6>
                      </v-card-text>
                      <div class="text-center">
                    ...
                    <v-col cols="12" md="6">
                      <v-card-text class="mt-12">
                        ...
                        <h6
                          class="text-center  grey--text "
                        >Log in to view the contents of the school file</h6>
                        <v-row align="center" justify="center">
                          <v-col cols="12" sm="8">
                           <v-row>
                           <v-col cols="12" sm="6">
